...
namespace NCL {
	...
	public:
		...
		static bool CapsuleIntersection(const CapsuleVolume& volumeA, const Transform& worldTransformA, const CapsuleVolume& volumeB,
		...
		static void         ClosestPt(const Vector3& p1, const Vector3& q1, const Vector3& p2, const Vector3& q2, Vector3& closestA, Vector3& closestB);
